...
public class testClass {
    ...
    public void Common2Arrays1() {
        ...
        Common2Arrays_Ok.main(new String[0]);
    ...
    public void diffBetweenMaxMin1() {
        ...
        diffBetweenMaxMin_Ok.main(new String[0]);
    ...
    public void maxNumber1() {
        ...
        maxNumber_Ok.main(new String[0]);
    ...
    public void minNumber1() {
        ...
        minNumber_Ok.main(new String[0]);
    ...
    public void removeDuplicates1() {
        ...
        removeDuplicates_Ok.main(new String[0]);
    ...
    public void reverseArr1() {
        ...
        reverseArr_Ok.main(new String[0]);
    ...
    public void sameFirstAndLast1() {
        ...
        sameFirstAndLast_Ok.main(new String[0]);
    ...
    public void changeArray1() {
        ...
        changeArray_Ok.main(new String[0]);
