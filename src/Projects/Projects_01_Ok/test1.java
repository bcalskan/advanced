...
import java.io.PrintStream;
 ...
 public class test1 {
     ...
     public void checkNumberEven1() {
         ...
         checkNumberEven_Ok.main(new String[0]);
     ...
     public void totalLetterCountCheck1() {
         ...
         totalLetterCountCheck_Ok.main(new String[0]);
     ...
     public void perfectSquare1() {
         ...
         perfectSquare_Ok.main(new String[0]);
     ...
     public void printEvenNumbers1() {
         ...
         printEvenNumbers_Ok.main(new String[0]);
     ...
     public void RandomNum() {
         ...
         RandomNum_Ok.main(new String[0]);
     ...
     public void factorialNumber1() {
         final String testString = "7";
         provideInput(testString);
         factorialNumber_Ok.main(new String[0]);
     ...
     public void twoString1() {
         ...
         provideInput(testString);
         twoString_Ok.main(new String[0]);
